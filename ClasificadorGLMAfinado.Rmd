...
# 4. Crear el modelo GLM con los datos de entrenamiento y probarlo con los datos de ensayo (familia binomial)
...
a1<-classif.glm(CatEnt~x, data = dat, family = binomial()) # Se obtienen los parametros de GLM, dentro del objeto estan las probabilidades e clasificacion
...
# 5. Crear el modelo GLM con los datos de entrenamiento y probarlo con los datos de ensayo (Usando datos sin suavizamiento) con familia binomial
...
# 6. Crear el modelo GLM con los datos de entrenamiento y probarlo con los datos de ensayo (Usando datos sin suavizamiento) con familia gaussian
...
fd_smoothEntfdata <- fdata(t(matrix_data)) # Se convierte en fdata los datos de entrenamiento fd
dat=list("df"=CatEntDF,"x"=fd_smoothEntfdata) # se crea la lista con las categorias de las curvas de entrenamiento y los datos funciones de entrenamiento
a1<-classif.glm(CatEnt~x, data = dat, family = gaussian()) # Se obtienen los parametros de GLM, dentro del objeto estan las probabilidades de clasificacion
...
# 7. Crear el modelo GLM con los datos de entrenamiento y probarlo con los datos de ensayo (Usando datos sin suavizamiento) con familia poisson
...
fd_smoothEntfdata <- fdata(t(matrix_data)) # Se convierte en fdata los datos de entrenamiento fd
dat=list("df"=CatEntDF,"x"=fd_smoothEntfdata) # se crea la lista con las categorias de las curvas de entrenamiento y los datos funciones de entrenamiento
a1<-classif.glm(CatEnt~x, data = dat, family = poisson()) # Se obtienen los parametros de GLM, dentro del objeto estan las probabilidades e clasificacion
...
# 8. Crear el modelo GLM con los datos de entrenamiento y probarlo con los datos de ensayo (Usando datos sin suavizamiento) con familia quasi
...
fd_smoothEntfdata <- fdata(t(matrix_data)) # Se convierte en fdata los datos de entrenamiento fd
dat=list("df"=CatEntDF,"x"=fd_smoothEntfdata) # se crea la lista con las categorias de las curvas de entrenamiento y los datos funciones de entrenamiento
a1<-classif.glm(CatEnt~x, data = dat, family = quasi()) # Se obtienen los parametros de GLM, dentro del objeto estan las probabilidades e clasificacion
...
# 9. Crear el modelo GLM con los datos de entrenamiento y probarlo con los datos de ensayo (Usando datos sin suavizamiento) con familia quasibinomial
...
fd_smoothEntfdata <- fdata(t(matrix_data)) # Se convierte en fdata los datos de entrenamiento fd
dat=list("df"=CatEntDF,"x"=fd_smoothEntfdata) # se crea la lista con las categorias de las curvas de entrenamiento y los datos funciones de entrenamiento
a1<-classif.glm(CatEnt~x, data = dat, family = quasibinomial()) # Se obtienen los parametros de GLM, dentro del objeto estan las probabilidades e clasificacion
...
# 10. Crear el modelo GLM con los datos de entrenamiento y probarlo con los datos de ensayo (Usando datos sin suavizamiento) con familia quasipoisson
...
fd_smoothEntfdata <- fdata(t(matrix_data)) # Se convierte en fdata los datos de entrenamiento fd
dat=list("df"=CatEntDF,"x"=fd_smoothEntfdata) # se crea la lista con las categorias de las curvas de entrenamiento y los datos funciones de entrenamiento
a1<-classif.glm(CatEnt~x, data = dat, family = quasipoisson()) # Se obtienen los parametros de GLM, dentro del objeto estan las probabilidades e clasificacion
...
# 11. Crear el modelo GLM con los datos de entrenamiento y probarlo con los datos de ensayo (usando curvas derivadas) familia binomial (suavizado afinado)

Corre en 2 minutos.

La fracción de acierto global es de 0.3602778, para imágenes dúctiles es de 0.3658333, para imágenes frágiles de 0.2891667 y para imágenes de fatiga 0.4258333.
...
# 12. Crear el modelo GLM con los datos de entrenamiento y probarlo con los datos de ensayo (usando curvas derivadas segundas) familia binomial (suavizado afinado)

Corre en 2 minutos.

La fracción de acierto global es de 0.3613889, para imágenes dúctiles es de 0.3525, para imágenes frágiles de 0.3841667 y para imágenes de fatiga 0.3475.


Por fotos:
La fracción de acierto global es de 0.333,

Ninguna de tres dúctiles se adjudican a dúctil. Acierto 0%.
...
fd_smoothEntfdata <- fdata(fd_smoothEntCenter,1:200) # Se convierte en fdata los datos de entrenamiento fd
dat=list("df"=CatEntDF,"x"=fd_smoothEntfdata) # se crea la lista con las categorias de las curvas de entrenamiento y los datos funciones de entrenamiento
a1<-classif.glm(CatEnt~x, data = dat, family = gaussian()) # Se obtienen los parametros de GLM, dentro del objeto estan las probabilidades e clasificacion
