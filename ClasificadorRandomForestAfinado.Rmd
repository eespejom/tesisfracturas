...
# 4. Crear el modelo RandomForest con los datos de entrenamiento y probarlo con los datos de ensayo

Corre en 2 minutos.

Por Curvas:
La fracción de acierto global es de 0.6544444, para imágenes dúctiles es de 0.6766667, para imágenes frágiles de 0.7783333 y para imágenes de fatiga 0.5083333.
...
Una de fatiga se adjudica correctamente. Acierto 33.33%.
...
a1<-classif.randomForest(CatEnt~x, data = dat) # Se obtienen los parametros de RandomForest, dentro del objeto estan las probabilidades e clasificacion
...
p1<-predict(a1,newdat) # se hace la predicción de la categoria de las curvas de ensayo de acuerdo al modelo RandomForest, el objeto entregado es un factor
